...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`CarGenetics`}</title>

        <meta
          name="description"
          content="Unleash the Power of Sharing with CarGenetics - Managing Profiles, Reservations, Vehicle Information, and Performance Assessments All in One Place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the Power of Sharing with CarGenetics - Managing Profiles, Reservations, Vehicle Information, and Performance Assessments All in One Place.`}
            </Text>
            <Box
