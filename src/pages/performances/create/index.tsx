      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'fuel_efficiency',
              isInvalid: !!formik.errors?.fuel_efficiency,
            }}
            name="fuel_efficiency"
            error={formik.errors?.fuel_efficiency}
            value={formik.values?.fuel_efficiency}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('fuel_efficiency', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
